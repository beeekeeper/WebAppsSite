...
$stmt->bindParam(':filmID', $sFilmID, PDO::PARAM_INT); //$sFilmID is safe film id
$stmt->execute();
  ...
  <div class="container-fluid">
    ...
    <div class="row">
    	<div class="col-md-4">
					<?php 
					// add image here
          echo "<img src=\"images/$row->filmImage\">";
          echo "<p><img src=\"images/stars/star-rating-{$row->filmReview}.png\"</p>"; // loads up image based on the star rating 
          ?>
            </div>
            <div class="col-md-8">
					<?php
