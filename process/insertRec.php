...
// prepare statement
$sql = "INSERT INTO recipes(recName, recDescription, recImage, recImageDesc, recIngredients, recMethod, recType, recDiet)
        VALUES(:recName, :recDescription, :recImage, :recImageDesc, :recIngredients, :recMethod, :recType, :recDiet)";
