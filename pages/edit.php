...
<div class="container-fluid">
    <div class="row">
        <div colspan="12">
            <h3>EDIT-<?php echo $row->recName; ?></h3>
        </div>
    </div>
</div>

<div class="row">        
    <form name="form1" method="post" action="../process/editRec.php"> <!--  -->
        <div class="col-md-5 col-md-offset-1">
            ...
            <div>
                ...
                <input type="text" name="recName" id="recName"  class="form-control" value="<?php echo $row->recName; ?>">
            ...
            <div>  
                ...
                <input type="text" name="recDiet" id="recDiet" class="form-control" value="<?php echo $row->recDiet; ?>">
            ...
            <div>          
                ...
                <input type="text" name="recDescription" id="recDescription" class="form-control" value="<?php echo $row->recDescription; ?>">
                  
            </div>

            <div>       
                <h1><label for="recImage">IMAGE NAME</label></h1>
                <input type="text" name="recImage" id="recImage"  class="form-control" value="<?php echo $row->recImage; ?>">            
            </div>

            <div>                        
                <h1><label for="recImageDesc">ORIGINAL IMAGE SOURCE</label></h1>
                <input type="text" name="recImageDesc" id="recImageDesc"  class="form-control" value="<?php echo $row->recImageDesc; ?>">                
            </div>
        ...
        <div class="col-md-5">
            ...
            <div>     
                ...
                <input type="text" name="recType" id="recType" class="form-control" value="<?php echo $row->recType; ?>">          
            </div>
            
            <div>               
                <h1><label for="recIngredients">INGREDIENTS</label></h1>
                <input style="height:200px;" type="text" name="recIngredients" id="recIngredients" class="form-control" value="<?php echo $row->recIngredients; ?>">  
            </div>

            <div>         
                <h1><label for="recMethod">METHOD</label></h1>
                <input style="height:200px;" type="text" name="recMethod" id="recMethod" class="form-control" value="<?php echo $row->recMethod; ?>">     
            </div>
        ...
        <div class="col-md-12" style="margin:30px; text-align:center;">             
                <input style="text-align:center;font-family: 'Oswald', 'PT Sans', 'Helvetica Neue', 'Helvetica', 'Arial', 'sans-serif';
                    font-size:18px;font-weight:800;color:#222;text-transform:uppercase;border-style:none;" type="submit" name="button" id="button" value="Update" class="btn btn-default">
         </div>
