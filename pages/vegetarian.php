...
<div class="container-fluid">
    <div> <!-- background of the row, sets it all to a pale grey instead of just behind the 'buttons' -->
        ...
        <div class="col-md-1">
        <a  href="../pages/breakfast.php"><p class="dropBtn2">B R E A K F A S T</p></a>
        </div>
        <div class="col-md-1">
        <a  href="../pages/main.php"><p class="dropBtn2" href="#">M A I N</p></a>
        </div>
        <div class="col-md-1">
        <a  href="../pages/side.php"><p class="dropBtn2" href="#">S I D E</p></a>
        </div>
        <div class="col-md-1">
        <a  href="../pages/salad.php"><p class="dropBtn2" href="#">S A L A D</p></a>
        </div>
        <div class="col-md-1">
        <a  href="../pages/snack.php"><p class="dropBtn2" href="#">S N A C K</p></a>
        </div>
        <div class="col-md-1">
        <a  href="../pages/dessert.php"><p class="dropBtn2" href="#">D E S S E R T</p></a>
        </div>
        <div class="col-md-1">
        <a  href="../pages/drink.php"><p class="dropBtn2" href="#">D R I N K</p></a>
        </div>
        <div class="col-md-1">
...
<div class="container-fluid">
    <div class="row">
        <div colspan="12" style="text-align:center;">
            <h1 style="background-color:lavender;">V E G E T A R I A N</h1> <!-- #e5e5e5 -->
        </div>
    </div>
</div>
...
<div class="container-fluid">
    <div class="row">
        <div class="cell col-md-10 col-md-offset-1">
            <?php 
            $queryRecipes = "SELECT * FROM recipes WHERE recDiet LIKE '%V%'";
