...
<div class="container-fluid" style="text-align:center;">
  <div class="row">
    <div class="col-md-2 col-md-offset-4">
            <h3>E M A I L : tabemashouu@gmail.com</h3> <!-- Add <li></li> tags to these for the css -->
    </div>
    <div class="col-md-2">
            <h3>A D D R E S S : Cantor, 153 Arundel St, Sheffield</h3>
    </div>
  </div>
</div>
...
<div class="container-fluid" style="text-align:center;">
  <div class="row">
    <div class="col-md-2 col-md-offset-4">
            <h3>T E L : XXXX-XXXX-XXXX</h3>
    </div>
    <div class="col-md-2">
            <h3>P O S T C O D E : S1 2NT</h3>
    </div>
  </div>
</div>
